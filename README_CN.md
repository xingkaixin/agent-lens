...
3. **会话树侧边栏** —— 按项目身份浏览会话，并按 Agent 或智能标签筛选
4. **会话列表** —— 按最新时间排序浏览会话，每张卡片显示标题、工作目录、消息数和总成本
5. **智能标签与会话收藏** —— 快速识别会话意图，固定需要反复查看的会话，并在 Dashboard 或会话视图中管理
6. **会话详情** —— 点击任意会话查看完整回放，包括 receipt 摘要、用户消息、Assistant 回复、工具调用、推理步骤、模型标签和文件变更
